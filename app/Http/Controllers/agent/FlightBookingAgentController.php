...
class FlightBookingAgentController extends Controller
{
    public function FlightBookingViewAgent(Request $request)
    {
    ...
    public function FlightSearchResultViewAgent(Request $request)
    {
        return view('agent.pages.flight_search_result');
    }
    public function OneWayFlightSearchAgent(Request $request)
    {
    ...
    public function FlightSearchResultViewAjaxAgent()
    {
        $searchResults = $this->AirSearch();
        return response()->json($searchResults);
    }
    public function FlightHubBookViewAgent()
    {
       
        return view('agent.pages.flight_hub_book');
    }
    public function FlightHubReviewViewAgent()
    {
        return view('agent.pages.flight_hub_review');
    }
    ...
    //air search
    public function AirSearchAgent()
    {
        $client = new Client();
        $url = "http://api.sandbox.flyhub.com/api/v1/AirSearch";
        $params = [
    ...
    //air check promotion
    public function AirCheckPromotionAgent()
    {
        $client = new Client();
    ...
    public function AirMiniRulesAgent()
    {
        $client = new Client();
    ...
    public function FlightAirRulesAgent(Request $req)

    {
     ...
     public function FlightAirPromotionAgent(Request $req)
     {
     ...
     public function FlightAirCheckPromotionAgent(Request $req)
     {
     ...
     public function FlightAirPriceAgent(Request $req)
    {
        ...
        return view('agent.pages.prebook',compact('fares','segments','totalfare','discount'));
        // return $responseBody;
    ...
    public function FlightPreBookAgent(Request $req)

    {
        ...
        if($responseBody['Error']!=null){
           ...
           return  view('agent.pages.error',compact('errors'));
            ...
            return view('agent.pages.flight_hub_review',compact('fares','segments','totalfare','discount'));
        }
    ...
    public function FlightAirBookAgent2(Request $req)

    {
        ...
        if (array_key_exists("BookingStatus",$responseBody)) {
            if($responseBody['BookingStatus']=="Booked"){
                ...
                return view('agent.pages.flight_booked',compact('booked_fares','booked_segments','booked_totalfare','booked_discount'));
            }
        ...
        return view('agent.pages.hub_success');
        
      }

    }

    public function FlightAirRetriveAgent($b_id){
    ...
    public function FlightAirTicketAgent(){
        ...
        return view('agent.pages.hub_success',compact('fares','segments','totalfare','discount','airline'));

    }

    public function FlightAirTicketCancelAgent(){
       ...
       if($responseBody['BookingStatus']=="InProcess"){
            ...
            return view('agent.pages.flight_cancel',compact('cancel_response'));
        }
    ...
    public function  FlightShowInvoiceAgent($b_id){
        $booking_id =$b_id;
        $token_id = Session::get('TOKEN_ID');
        $client = new Client();
        $url = "http://api.sandbox.flyhub.com/api/v1/AirCancel";
    ...
    public function create_infos($booking_id,$lead_pax,$origin,$destination,$contact_no,$amount,$status,$airline,$duration,$arrival_time, $departure_time,$flight_no,$aircraft, $class, $f_name,$l_name, $baggage){
      ...
      public function GetTicketViewAgent()
      {
         $token_id = Session::get('TOKEN_ID');
        // $client = new Client();
        // $url = "http://api.sandbox.flyhub.com/api/v1/AirCancel";
        ...
        dd($token_id);
          return view('agent.pages.view_tickets');
      }
