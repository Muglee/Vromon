                            ...
                            <div class="container-fluid">
                                <div class="row mb-2">
                                    <div class="col-sm-2">
                                        ...
                                        {{-- <a class="btn btn-primary" href="{{ url('agent/manage_hotel_package') }}">Add Hotel Package </a> --}}
                                    </div><!-- /.col -->
                                    <div class="col-sm-10">
                                        <ol class="breadcrumb float-sm-right">
                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                            ...
                                                            <form class="authentication-form mt-4">
                                                                ...
                                                                <div class="mt-4">
                                                                    {{-- <a class="btn btn-primary"  href="{{ url('agent/flight_search_result') }}">Search Flight </a> --}}
                
                
                                                                    {{-- <a href="{{ url('agent/flight_search_result') }}"
                                                            ...
                                                            <form class="authentication-form mt-4">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="mt-4">
                                                                            {{-- <button href="{{ url('agent/flight_search_result') }}"
                                                                            style="text-decoration: none;"
                                                                            class="btn btn-outline-primary btn-flat">Search Flight</button> --}}
                                                                            ...
                                                                            {{-- <button href="{{ url('agent/flight_search_result') }}" style="text-decoration: none;" class ="btn btn-outline-primary btn-flat">Search Flight</button> --}}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="tab-pane fade active show" id="contact" role="tabpanel"
                                                            ...
                                                            {{-- <form action="{{ route('agent.OneWayFlightSearch') }}" method="get" --}}
                                                            <form class="mt-4">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div>
                                                                <a href="{{ url('agent/flight_hub_book') }}" style="font-size: 15px;"
                ...
                @section('extra-js')
                    ...
                    function remove() {
                        ...
                        function getFlightsMulti(e) {
                            ...
                            $.ajax({
                                method: "POST",
                                url: "{{ route('agent.OneWayFlightSearch') }}",
                                data: {
                                    AdultQuantity: adult,
                                    ChildQuantity: child,
