...
@section('title', 'Table Booking Form')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Table Booking Form</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
{{--                        <li class="breadcrumb-item active">{{ $result->table_name }}</li>--}}
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
{{--                                        <input type="hidden" name="room_id" value="{{$id}}" class="form-control">--}}
                                        <input type="hidden" name="table_id" value="{{$result->id}}" class="form-control">
