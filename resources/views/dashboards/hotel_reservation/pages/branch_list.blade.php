...
{{--                                        @endfor--}}
                                    ...
                                    <td>
                                        ...
                                        {{-- {{ dd($data) }} --}}
                                            <a href="{{url('vendor/hotel/status/0')}}/{{$data->id}}" class="badge bg-success"> Activated</a>
                                        @elseif($data->is_status_active==0)
                                            <a href="{{url('vendor/hotel/status/1')}}/{{$data->id}}" class="badge bg-danger">Deactivated</a>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{url('vendor/hotel/branch_view')}}/{{$data->id}}"class="btn bg-gradient-secondary btn-flat"><i class="fas fa-eye"></i></a>
                                        <a href="{{url('vendor/hotel/manage_branch')}}/{{$data->id}}" class="btn bg-gradient-info   btn-flat"><i class="fas fa-edit"></i></a>
                                        <a href="{{url('vendor/hotel/branch/delete')}}/{{$data->id}}" class="btn bg-gradient-danger btn-flat"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
