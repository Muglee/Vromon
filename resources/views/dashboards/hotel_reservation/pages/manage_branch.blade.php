        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <form action="{{route('hotel.ManageBranchProcess.Vendor')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" value="{{$branch_country}}" name="branch_country" class="form-control"  placeholder="Enter Country Name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
