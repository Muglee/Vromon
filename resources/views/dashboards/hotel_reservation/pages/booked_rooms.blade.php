                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach ($result as $key=>$data)
                                    <tr>
                                        ...
                                        <td>
                                            <a  href="{{url('vendor/hotel/cancel')}}/{{$data->id}}" class="btn btn-outline-danger btn-sm">Cancel book</a>
                                            <a   href="{{url('vendor/hotel/invoice')}}/{{$data->id}}" class="btn btn-outline-primary btn-sm">Invoice</a>
