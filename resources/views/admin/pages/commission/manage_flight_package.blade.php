            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-10">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Flight Packages</li>
                        <li class="breadcrumb-item active">Add Flight Packages</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Add Flight Package</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <form action="{{ route('admin.ManageFlightPackageProcess') }}" method="POST">
                            @csrf
