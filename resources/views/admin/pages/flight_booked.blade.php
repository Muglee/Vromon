                            ...
                            <div class="col-md-12 pt-4 pb-4">
                                ...
                                <div class="row pt-3 pb-3 " style="font-size: 14px;">
                                    ...
                                    <div class="col-md-6 " style="float: left">
                                        ...
                                        <form   method="get" action="{{ route('admin.FlightAirTicket') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6"  style="float:right">
                                        ...
                                        <form   method="get" action="{{ route('admin.FlightAirTicketCancel') }}" enctype="multipart/form-data">
