            ...
            <div class="card card-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <form action="{{ route('admin.ManageServiceProcess') }}" method="POST">
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text"  name="services_name" value="{{ $services_name }}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            {{-- <input type="text" name="description" id="description" value="{{ $description }}"  class="form-control" required> --}}
