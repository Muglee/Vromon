                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            ...
                                            <form class="authentication-form mt-4">
                                                ...
                                                <div class="mt-4">
                                                    {{-- <a class="btn btn-primary"  href="{{ url('admin/flight_search_result') }}">Search Flight </a> --}}


                                                    {{-- <a href="{{ url('admin/flight_search_result') }}"
                                        ...
                                        <div class="tab-pane fade active show" id="contact" role="tabpanel"
                                            ...
                                            {{-- one way --}}
                                            {{-- <form action="{{ route('admin.OneWayFlightSearch') }}" method="get" --}}
                                            <form class="mt-4">
...
@section('extra-js')
    ...
    function remove() {
        ...
        function getFlightsMulti(e) {
            ...
            $.ajax({
                method: "POST",
                url: "{{ route('admin.OneWayFlightSearch') }}",
                data: {
                    AdultQuantity: adult,
                    ChildQuantity: child,
