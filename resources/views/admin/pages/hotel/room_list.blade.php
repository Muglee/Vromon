                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($data->is_status_active==1)
                                            <a href="{{url('admin/hotel/room/status/0')}}/{{$data->id}}" class="badge bg-success"> Activated</a>
                                        @elseif($data->is_status_active==0)
                                            <a href="{{url('admin/hotel/room/status/1')}}/{{$data->id}}" class="badge bg-danger">Deactivated</a>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="p-1">
                                                <a href="{{url('admin/hotel/manage_room')}}/{{$data->id}}" class="btn bg-gradient-info   btn-flat"> <i class="fas fa-edit"></i> </a>
                                            </div>
                                            <div class="p-1">
                                                <a href="{{url('admin/hotel/room/delete')}}/{{$data->id}}" class="btn bg-gradient-danger btn-flat"> <i class="far fa-trash-alt"></i> </a>
                                            </div>
                                        </div>
