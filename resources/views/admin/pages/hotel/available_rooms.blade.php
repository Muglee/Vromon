                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach ($rooms as $key=>$data)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <a href="{{url('admin/hotel_booking_form')}}/{{$data->id}}"  class="btn btn-sm btn-outline-success">Book now</a>
                                            </div>
...
{{--                                        </td>--}}
{{--                                        <td>--}}
{{--                                            <a href="{{url('admin/hotel/booking_form')}}/{{$data->id}}"  class="btn btn-sm btn-outline-success">Book</a>--}}
{{--                                        </td>--}}
{{--                                    </tr>--}}
{{--                                    @endforeach--}}
{{--                                </tbody>--}}
