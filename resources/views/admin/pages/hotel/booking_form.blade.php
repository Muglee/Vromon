                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-10" >
                                <div class="card card-info">
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="{{route('room.ManageBookProcess')}}" method="post" class="form-horizontal">
                                        @csrf
...
{{--                                            <a type="submit" class="btn btn-info" href="{{url('admin/hotel/room/booking_status/1')}}/{{$result->id}}" >Confirm </a>--}}
