                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        {{-- @php
                            dd($id);
                        @endphp --}}
                        <form action="{{ route('admin.restaurant.details') }}" method="post">
                            @csrf
...
<script src="http://localhost/vromoon-main/public/dashboard/plugins/jquery/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="http://localhost/vromoon-main/public/dashboard/plugins/jquery-ui/jquery-ui.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('input[name="time_slots[]"]').on('change', function() {
                ...
                $.get(url + "/admin/admin_restaurant_booking/find/getEmptyTables/" + text[0] + "/" + text[1] + "/" + text[2] + "/" + timeslot,
                    function(extra) {
                        var vDiv = ``;
