                                ...
                                <div class="form-group pt-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            @if($table_img!='')
                                                <div class="mt-3" >
                                                    <img width="100px" height="100px" id="table_img" src="{{asset('/storage/media/outlet/table_img/'.$table_img)}}"/>
                                                </div>
                                            @else
                                                <div class="mt-3" >
                                                    <img width="100px" height="100px" id="table_img" src="{{ asset('dashboard/dist/img/dummy_image.jpg')}}" />
                                                </div>
                                            @endif
