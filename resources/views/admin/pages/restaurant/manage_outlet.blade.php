        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <form action="{{route('admin.outlet.ManageOutletProcess')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{$id}}" class="form-control" >
                            <input type="hidden" name="vendor_id" value="{{$vendor}}" class="form-control" >
                            <div class="card-body">
                                ...
                                <div class="form-group pt-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            @if($outlet_logo!='')
                                                <div class="mt-3" >
                                                    <a href="{{asset('/storage/media/outlet/logo/'.$outlet_logo)}}" target="_blank"><img id="logo" width="100px" height="100px;" src="{{asset('/storage/media/outlet/logo/'.$outlet_logo)}}"/></a>
                                                </div>
                                            @else
                                                <div class="mt-3" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            @if($outlet_cover_image!='')
                                                <div class="mt-3" >
                                                    <a href="{{asset('/storage/media/outlet/CoverImages/'.$outlet_cover_image)}}" target="_blank"><img id="cover" width="100px" height="100px;" src="{{asset('/storage/media/outlet/CoverImages/'.$outlet_cover_image)}}"/></a>
                                                </div>
                                            @else
                                                <div class="mt-3" >
