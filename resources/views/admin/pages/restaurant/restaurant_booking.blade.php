    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <form action="{{ route('admin.restaurant.search') }}" method="post">
                    @csrf
                    <input type="hidden" value="{{ Session::get('ADMIN_ID') }}" id="admin_id">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group date" id="dateForBooking" data-target-input="nearest">
                                    ...
                                    required />
                                    <div class="input-group-append" data-target="#dateForBooking" data-toggle="datetimepicker">
