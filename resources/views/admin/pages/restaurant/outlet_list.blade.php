                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-2 addButton">
                                <a href="{{route('admin.Manage.outlet',$vendor_id)}}" class="btn btn-success">Add
                                    Outlet</a>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($result as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                <img width="100px" height="100px"src="{{ asset('/storage/media/outlet/CoverImages/' . $data->outlet_cover_image) }}" />
                                            </td>
                                            <td>
                                                <img width="100px" height="100px"
                                                    src="{{ asset('storage/media/outlet/logo/' . $data->outlet_logo) }}" />
                                            </td>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    {{-- <div class="p-1">
                                                        <a href="{{ url('admin/manage_outlet') }}/{{ $data->id }}"
