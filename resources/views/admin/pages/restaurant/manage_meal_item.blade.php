                                ...
                                <div class="form-group pt-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            @if($item_image!='')
                                                <div class="mt-3" >
                                                    <img width="100px" height="100px" id="item_image" src="{{asset('/storage/media/food_item_image/'.$item_image)}}"/>
                                                </div>
                                            @else
                                                <div class="mt-3" >
                                                    <img width="100px" height="100px" id="item_image" src="{{ asset('dashboard/dist/img/dummy_image.jpg')}}" />
                                                </div>
                                            @endif
