	...
	<div class="row" id="printableArea">
		<div class="col-sm-12" style="border-style: ridge; margin-top: 10px;">
			<div class="header">
				...
				<div class="col-sm-4">
					<h4 style="font-size: 14px;">Booking Ref: {{$get_ticket->status}}</h4>
				</div>
				<div class="col-sm-4">
				    <h4 style="font-size: 14px;">Issue Date: {{$get_ticket->date}} | PNR: <b>{{$get_ticket->pnr}}</b></h4>
				</div>
			</div>
				<div class="row">
				<div class="col-sm-12">
					<table style="width:100%; border-collapse: inherit !important;">
					  ...
					  <tr style="background-color: #e4fcff;">
						...
						<td>{{$get_ticket->origin}}						
						<br />{{$get_ticket->departure_time}}<br/>21:00Hrs<br />
						</td>
			            <td>{{$get_ticket->destination}}</strong>
							<br />{{$get_ticket->arrival_time}}<br />21:45Hrs<br />
						</td>
						
						<td>{{$get_ticket->duration}}</td>
						
						<td>{{$get_ticket->flight_no}}</td>
						
						<td>{{$get_ticket->aircraft}}</td>
