...
<head>
    ...
    <title>@yield('title') || Vromoon || The Best online travel agency in Bangladesh</title>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/dist/css/font-mytravel.css') }}"> --}}
    ...
    <!-- DataTables -->
    <link rel="stylesheet"
        href="{{ asset('dashboard/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet"
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="{{ asset('dashboard/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{ asset('dashboard/plugins/daterangepicker/daterangepicker.css') }}">
    <!-- summernote -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('web/assets/images/favicon.png') }}" alt="AdminLTELogo"
                height="60" width="60">
        </div>
    ...
    {{-- <script src="{{ asset('dashboard/dist/js/pages/date.js') }}"></script> --}}
    <!-- DataTables  script -->
    ...
    <script>
        $(document).ready(function() {
            // $('.noticeDiv').html('');
            var main_url = "{{ URL::to('/') }}";
            $.get(main_url + "/admin/notice/view", function(notice) {
                $('.noticeDiv').html(notice.notice);
