            ...
            <div class="callout callout-info">
                ...
                <form action="{{route('user.UpdateProfile')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" name="user_name" value="{{ $info->user_name }}" type="text" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" name="user_company_name" value="{{ $info->user_company_name }}" type="text" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" name="user_phone_no" value="{{ $info->user_phone_no }}" type="text" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" name="user_email" value="{{ $info->user_email }}" type="text" disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" name="user_address" value="{{ $info->user_address }}" type="text" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        {{--  <div class="col-md-3">
                        ...
                        {{--  <div class="col-md-4">
                            ...
                            @if($info->logo!='')
                            <div class="mt-3" >
                                <img width="100px" height="100px" id="img" src="{{asset('storage/media/user/company_logo/'.$info->logo)}}"/>
                            </div>
                            @else
                                <div class="mt-3" >
