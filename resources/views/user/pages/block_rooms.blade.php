...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row pb-4">
                <div class="col-md-12">
                    <form action="{{ route('user.booked_customer_info') }}" method="POST">
                        @csrf
                        <div class="callout callout-info">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                    ...
                                    <a href="{{ route('user.addpay') }}" style="float: right; color: #495057; text-decoration: none; background: white; padding: 0px 8px; border-radius: 3px;;">Recharge Your Account </a>
                        ...
                        @if ($room_rent >= $wallet)
                            <div class="col-3">
                                <a class="btn btn-info w-100" href="{{ route('user.addpay') }}">Recharge Your Account </a>
                            </div>
                        @else
                            <div class="col-3">
