                        ...
                        <div class="row p-3">
                            <div class="col-md-12 pt-4 pb-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-right" style="font-size: 15px;">
                                            ...
                                            <p style="padding: 0;margin: 0;font-size: 12px;">{{$booked_fares[0]['BaseFare']}}</p>
                                            <p style="padding: 0;margin: 0;font-size: 12px;">{{$booked_fares[0]['Tax']}}</p>
                                            <p style="padding: 0;margin: 0;font-size: 12px;">{{$booked_totalfare }}</p>
                                ...
                                <div class="row pt-3 pb-3 " style="font-size: 14px;">
                                        ...
                                        @foreach ($booked_segments as $item)
                                        ...
                                        <div class="col-md-12 pt-4 pb-4">
                                            ...
                                            <div class="row pt-3 pb-3 " style="font-size: 14px;">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    {{-- '/storage/media/branch/CoverImages/' --}}
                                    ...
                                    <div class="col-md-6 " style="float: left">
                                        @if( $status=="Booked")
                                        <form   method="get" action="{{ route('user.FlightAirTicket') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6"  style="float:right">
                                        ...
                                        <form   method="get" action="{{ route('user.FlightAirTicketCancel') }}" enctype="multipart/form-data">
                                            <div class="col-md-4 p-2 m-2" style="float:right">
