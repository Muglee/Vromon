            ...
            <div class="header-content m-auto">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Book Bus Tickets</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="about-selection-details">
                                    <!-- ===========bus========== -->
                                    <div class="about-selection-details-item active" data-about-details="4">
                                                    ...
                                                    <div class="authentication-box">
                                                        <div class="authentication-box-inner">
                                                            <form class="authentication-form mb-20">
                                                                ...
                                                                <button type="submit" class="btn main-btn main-btn-lg">Search Bus</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
