            ...
            <div class="header-content m-auto">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('restaurant_reservasion')}}">Restaurant Reservasion</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 desk-pad-left-40">
                        <div class="details-card-content">
                            ...
                            <a href="#" class="btn main-btn main-btn-arrow">Book This Restaurant <i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                </div>
            </div>
