    ...
    <header class="inner-page-header inner-page-header-4">
        ...
        <div class="container">
            <div class="header-content m-auto">
                <h1> Restaruant Reservation</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Restaruant Reservation</li>
                    </ol>
                </nav>
            </div>
        </div>
                                                            ...
                                                            <form class="authentication-form mb-20">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="input-group input-group-bg mb-20">
                                                                            <input type="text" class="form-control" placeholder="FORM" aria-label="Name" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <label class="mb-2 custom-label">ROOM</label>
                                                                ...
                                                                <button type="submit" class="btn main-btn main-btn-lg">Search Hotel</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="row load-more-gallery">
                <div class="col-sm-6 col-lg-4 pb-30 hotel-more-item">
                    <div class="destination-card">
                        <div class="destination-card-image">{{('restaurant_details')}}            <a href="{{('restaurant_details')}}">
                        ...
                        <div class="destination-card-content">
                            ...
                            <div class="destination-redirect">
                                <a href="{{('restaurant_details')}}">Explore Tour <i class="flaticon-export"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
