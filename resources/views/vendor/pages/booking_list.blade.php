...
@section('booking_list', 'menu-open')
                                ...
                                <tbody>
                                    ...
                                    @foreach ($restaurantLists as $restaurantList)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="p-1">
                                                    <a onclick="return confirm('Are you sure you want to delete booking schedule?')"
                                                        href="{{ route('restaurant.booking.delete', $restaurantList['id']) }}"
                                            ...
                                            <td>
                                                <div class="p-1">
                                                <a   href="{{ route('manage.booking', $restaurantList['id']) }}" class="btn bg-gradient-info   btn-flat"> 
                                            ...
                                            <td>
                                                <div class="p-1">
                                                    ...
                                                    <a   href="{{url('vendor/restaurant/invoice/' .$restaurantList['id'] )}}" class="btn btn-outline-primary btn-sm">Invoice</a>
