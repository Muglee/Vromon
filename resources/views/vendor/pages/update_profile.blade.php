                ...
                <form action="{{route('vendor.UpdateProfile')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        {{--  <div class="col-md-4">
                            ...
                            @if($info->logo!='')
                            <div class="mt-3" >
                                <img width="100px" height="100px" id="img" src="{{asset('public/storage/media/vendor/company_logo/'.$info->logo)}}"/>
                            </div>
                            @else
                                <div class="mt-3" >
                                    <img width="100px" height="100px" id="img" src="{{ asset('public/dashboard/dist/img/dummy_image.jpg')}}" />
                                </div>
                            @endif
                        </div>  --}}
                    </div>
