...
@section('title', 'Book Restaurant Slots')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('restaurant.details') }}" method="post">
                            @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            $('input[name="time_slots[]"]').on('change', function() {
                ...
                $.get(url + "/getEmptyTables/" + text[0] + "/" + text[1] + "/" + text[2] + "/" + timeslot,
                    function(extra) {
                        var vDiv = ``;
